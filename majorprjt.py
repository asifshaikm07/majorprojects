...
class WeatherLayer:
    ...
    @staticmethod
    def get_conditions(location="Bengaluru"):
        ...
        try:
            ...
            return {
                ...
                "rain_prob_pct": rain_probability,
                "rain_in_4h": rain_present,
                "advisory": (
                    "⚠️ Delay spraying — rain expected."
                    if rain_present
                    else "✅ Conditions suitable for spraying."
                ),
            }
            ...
            return {
                ...
                "rain_prob_pct": 0,
                "rain_in_4h": False,
                "advisory": f"Weather API Error: {str(e)}",
            }
...
class PestDetectionApp(tk.Tk):
    ...
    def _build_right(self, parent):
        ...
        # Decision text (large)
        self.decision_text_var = tk.StringVar(value="")
